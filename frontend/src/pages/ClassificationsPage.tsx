...
export function ClassificationsPage() {
  ...
  const crud = useAppCrud("classifications");
  ...
  }, [confirmDelete, crud.canCreate, crud.canDelete, crud.canUpdate, openCreate, openEdit, searchTerm, selectedClassification, setHeaderActions, t]);
