...
export function CostCentersPage() {
  ...
  const crud = useAppCrud("cost-centers");
  ...
  }, [confirmDelete, crud.canCreate, crud.canDelete, crud.canUpdate, openCreate, openEdit, searchTerm, selectedCostCenter, setHeaderActions, t]);
