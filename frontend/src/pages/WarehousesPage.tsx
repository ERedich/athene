...
export function WarehousesPage() {
  ...
  const crud = useAppCrud("warehouses");
  ...
  }, [confirmDelete, crud.canCreate, crud.canDelete, crud.canUpdate, openCreate, openEdit, searchTerm, selectedWarehouse, setHeaderActions, t]);
