...
import { serviceContractsRouter } from "./serviceContracts.js";
import { dispatchBoardRouter } from "./dispatchBoard.js";
...
app.use("/api/service-contracts", requireAuth, serviceContractsRouter);
app.use("/api/dispatch-board", requireAuth, dispatchBoardRouter);
